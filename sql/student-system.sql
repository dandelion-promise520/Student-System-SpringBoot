...
) ENGINE=InnoDB AUTO_INCREMENT=5 DEFAULT CHARSET=utf8mb4 COMMENT='班级信息表';
/*!40101 SET character_set_client = @saved_cs_client */;
...
INSERT INTO `stu_class` VALUES (1,'本科计科一班','1','3','张铮','0','','2025-12-25 14:59:27','','2025-12-27 16:22:46',NULL),(2,'本科计科二班','2','3','111','0','','2025-12-25 16:37:16','','2025-12-27 16:22:53',NULL),(3,'本科计科一班','3','4','张铮','0','dandelion',NULL,'',NULL,NULL),(4,'本科计科二班','4','4','张铮','0','dandelion',NULL,'',NULL,NULL);
...
) ENGINE=InnoDB AUTO_INCREMENT=10 DEFAULT CHARSET=utf8mb4 COMMENT='学生成绩表';
/*!40101 SET character_set_client = @saved_cs_client */;
...
INSERT INTO `sys_dict_type` VALUES (1,'用户性别','sys_user_sex','0','admin','2025-12-24 19:10:58','',NULL,'用户性别列表'),(2,'菜单状态','sys_show_hide','0','admin','2025-12-24 19:10:58','',NULL,'菜单状态列表'),(3,'系统开关','sys_normal_disable','0','admin','2025-12-24 19:10:58','',NULL,'系统开关列表'),(4,'任务状态','sys_job_status','0','admin','2025-12-24 19:10:58','',NULL,'任务状态列表'),(5,'任务分组','sys_job_group','0','admin','2025-12-24 19:10:58','',NULL,'任务分组列表'),(6,'系统是否','sys_yes_no','0','admin','2025-12-24 19:10:58','',NULL,'系统是否列表'),(7,'通知类型','sys_notice_type','0','admin','2025-12-24 19:10:58','',NULL,'通知类型列表'),(8,'通知状态','sys_notice_status','0','admin','2025-12-24 19:10:58','',NULL,'通知状态列表'),(9,'操作类型','sys_oper_type','0','admin','2025-12-24 19:10:58','',NULL,'操作类型列表'),(10,'系统状态','sys_common_status','0','admin','2025-12-24 19:10:58','',NULL,'登录状态列表'),(11,'学生年级','sys_student_grade','0','dandelion','2025-12-27 16:17:01','',NULL,'学生年级列表');
...
) ENGINE=InnoDB AUTO_INCREMENT=212 DEFAULT CHARSET=utf8 COMMENT='操作日志记录';
/*!40101 SET character_set_client = @saved_cs_client */;
...
INSERT INTO `sys_user` VALUES (1,103,'dandelion','dandelion','00','1993466159@qq.com','18379810069','0','/profile/avatar/2025/12/27/23528d6259b140a4aa1fa2ae7c1b19c9.png','$2a$10$uRuwH7bcdMEsnaj9MP3wx.dYGvC39jvTiyn15KZ9ci5K3ipeiJp7y','0','0','127.0.0.1','2025-12-27 15:56:49','2025-12-26 12:05:39','admin','2025-12-24 19:10:57','','2025-12-27 16:37:27','管理员'),(2,105,'ry','若依','00','ry@qq.com','15666666666','1','','$2a$10$7JB720yubVSZvUI0rEqK/.VqGOZTH.ulu33dHOiBE8ByOhJIrdAu2','0','2','127.0.0.1','2025-12-24 19:10:57','2025-12-24 19:10:57','admin','2025-12-24 19:10:57','',NULL,'测试员'),(100,102,'test','test','00','dandelionpromise38@gmail.com','13769505874','0','/profile/avatar/2025/12/26/8612dd5f30474494aa1e6946496a17ee.png','$2a$10$pBFXKXR.100XBMEyGbEBKuxRMibAhpQyPobhFUNW7xRvJ7lgWnu.6','0','0','127.0.0.1','2025-12-26 14:30:35',NULL,'admin','2025-12-24 19:16:38','dandelion','2025-12-26 14:29:20',NULL),(101,109,'停用测试','停用测试','00','','','2','','$2a$10$DbtCCS8t0U1eToJgHUbm.uXlIWGPIT3HwrC7w4WaVOC5h8QECq4q2','1','0','',NULL,NULL,'dandelion','2025-12-26 14:30:05','',NULL,NULL);
...
INSERT INTO `sys_user_post` VALUES (1,1),(100,2),(101,4);
...
-- Dump completed on 2025-12-27 17:29:35
