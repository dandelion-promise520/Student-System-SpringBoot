package com.dandelion.common.utils.file;
...
import com.dandelion.common.exception.file.FileNameLengthLimitExceededException;
import com.dandelion.common.exception.file.FileSizeLimitExceededException;
import com.dandelion.common.exception.file.InvalidExtensionException;
import com.dandelion.common.utils.DateUtils;
import com.dandelion.common.utils.StringUtils;
import com.dandelion.common.utils.uuid.IdUtils;
import com.dandelion.common.utils.uuid.Seq;
...
public class FileUploadUtils
{
     ...
     * 默认上传的地址
     */
    private static String defaultBaseDir = DandelionConfig.getProfile();
    ...
    {
        int dirLastIndex = DandelionConfig.getProfile().length() + 1;
